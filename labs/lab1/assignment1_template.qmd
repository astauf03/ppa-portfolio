...
A widespread implementation of MOE Flagging should be employed at the state level. Counties with small populations and even smaller minoritiy populations should not only adhere to ACS data, but also leverage an ethnographic approach to voice the experiences of the minorities within the counties.
